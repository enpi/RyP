package com.codamasters.ryp.UI.degree;
...
public class DegreeCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = getIntent().getExtras().getString("degree_name", "Comments");
        degreeID = getIntent().getExtras().getString("degree_id", "Error");
        setTitle(title);


        // Setup our Firebase mFirebaseRef
        firebaseRef = FirebaseDatabase.getInstance().getReference().child("degree_comments").child(degreeID);
        ...
        findViewById(R.id.sendButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!anonymous)
                    ...
                    Toast.makeText(getApplicationContext(), "You can't comment a degree being anonymous.", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onStart() {
        ...
        mConnectedListener = firebaseRef.getRoot().child(".info/connected").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (connected) {
                    Toast.makeText(DegreeCommentActivity.this, "Connected", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DegreeCommentActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
                }
            }
