 ...
 */
public class ProfessorUniversityRankingListAdapter extends FirebaseListAdapter<Professor> {

    private Context context;

    public ProfessorUniversityRankingListAdapter(Context context, Query ref, Activity activity, int layout) {
