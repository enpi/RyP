 ...
 */
public class ProfessorRankingListAdapter extends FirebaseListAdapter<Professor> {

    private Context context;
    private int rank = 1;

    public ProfessorRankingListAdapter(Context context, Query ref, Activity activity, int layout) {
