 ...
 */
public class DegreeUniversityRankingListAdapter extends FirebaseListAdapter<Degree> {

    private Context context;

    public DegreeUniversityRankingListAdapter(Context context, Query ref, Activity activity, int layout) {
